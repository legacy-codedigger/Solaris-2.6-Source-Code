...
extern void pfgHelp(Widget widget,
                    XtPointer closure,
                    XtPointer calldata);
extern void localeGobackCB(Widget widget,
                           tu_ccb_arg_p closure,
                           XtPointer calldata);
...
/**************************************************************
 * tu_locale_dialog_widget:
 **************************************************************/
Widget tu_locale_dialog_widget(char    * name,
                               Widget    parent,
                               Widget ** warr_ret)
{
  Arg args[26];
  ...
  widget_array[WI_PANELHELPTEXT] =
    XmCreateText(widget_array[WI_LOCALE_DIALOG], "panelhelpText", args, n);
  ...
  widget_array[WI_FORM] =
    XmCreateForm(widget_array[WI_LOCALE_DIALOG], "form", args, n);
  ...
  widget_array[WI_MESSAGEBOX] =
    XmCreateMessageBox(widget_array[WI_LOCALE_DIALOG], "messageBox", args, n);
