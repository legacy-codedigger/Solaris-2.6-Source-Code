...
extern void upgrade_goback_cb(Widget widget,
                              tu_ccb_arg_p closure,
                              XtPointer calldata);
extern void pfgExit(Widget widget,
                    tu_ccb_arg_p closure,
                    XtPointer calldata);
extern void upgradeCB(Widget widget,
                      tu_ccb_arg_p closure,
                      XtPointer calldata);
...
extern void pfgHelp(Widget widget,
                    XtPointer closure,
                    XtPointer calldata);
extern void initialCB(Widget widget,
                      tu_ccb_arg_p closure,
                      XtPointer calldata);
...
/**************************************************************
 * tu_upgrade_dialog_widget:
 **************************************************************/
Widget tu_upgrade_dialog_widget(char    * name,
                                Widget    parent,
                                Widget ** warr_ret)
{
  Arg args[28];
  ...
  widget_array[WI_UPGRADE_DIALOG] =
  ...
  widget_array[WI_PANELHELPTEXT] =
    XmCreateText(widget_array[WI_UPGRADE_DIALOG], "panelhelpText", args, n);

  /***************** messageBox : XmMessageBox *****************/
  n = 0;
  XtSetArg(args[n], XmNdialogType, XmDIALOG_TEMPLATE); n++;
  widget_array[WI_MESSAGEBOX] =
    XmCreateMessageBox(widget_array[WI_UPGRADE_DIALOG], "messageBox", args, n);

  /***************** upgradeButton : XmPushButton *****************/
  widget_array[WI_UPGRADEBUTTON] =
    XmCreatePushButton(widget_array[WI_MESSAGEBOX], "upgradeButton", NULL, 0);

  /***************** initialButton : XmPushButton *****************/
  widget_array[WI_INITIALBUTTON] =
    XmCreatePushButton(widget_array[WI_MESSAGEBOX], "initialButton", NULL, 0);
  ...
  /***************** object of type : XmFormDialog *****************/
  n = 0;
  XtSetArg(args[n], XmNinitialFocus, widget_array[WI_INITIALBUTTON]); n++;
